...
%% Load data
load("./data/MATLABdata/ekf.mat", "em", "es", "s311", "s311mc", ...
...
plot(ts, -s344.*1000, 'Color', '#808080')
plot(ts, -s344mc.*1000, 'k')
leg1 = legend('Estimation Error', 'EKF $3\sigma$', 'MC $3\sigma$','Interpreter', 'latex');
...
print("./figures/EKFPosVelError.eps","-depsc","-r600")
...
leg2 = legend('Estimation Error', 'EKF $3\sigma$', 'MC $3\sigma$','Interpreter', 'latex');
...
set(gcf, "PaperPositionMode","Manual")
print("./figures/EKFMassError.eps","-depsc","-r600")
...
set(gcf, "PaperUnits","inches","PaperPosition",[0.25,0.25,6.5,8.0])
set(gcf, "PaperPositionMode","Manual")
print("./figures/EKFPosVelHist.eps","-depsc","-r600")
...
xlabel('$e_m$, kg', 'Interpreter', 'latex')
ylabel('# Occurances')
grid on
...
set(gcf, "PaperPositionMode","Manual")
print("./figures/EKFMassHist.eps","-depsc","-r600")